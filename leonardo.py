...
class LeonardoBoard:
    def __init__(self, avr):
        ...
        # Generated by AVR.generateDefsCode() from "avr/iom32u4.h" and "avr/portpins.h"
        ...
        avr.define("NUM_DIGITAL_PINS", 30)
        avr.define("NUM_ANALOG_INPUTS", 12)
        ...
        avr.define("A8", 26)  # D8
        avr.define("A9", 27)  # D9
        avr.define("A10", 28)  # D10
        avr.define("A11", 29)  # D12

        avr.define("SDA", 2)
        avr.define("SCL", 3)
        avr.define("LED_BUILTIN", 13)
...
class Leonardo(Arduino, LeonardoBoard, AVR):
